...
\begin{center}
    ...
    \begin{tabularx}{\textwidth}{l l >{\raggedleft}X l}
        ...
        学{\quad\quad}号： & \underline{\hfill \phantom{12345678} \hfill}
    \end{tabularx}
\end{center}
...
\begin{center}
    \bfseries \zihao{-2}
    \begin{tabularx}{.9\textwidth}{p{4cm}X} %{>{\fangsong}l X<{\centering}}
        ...
        {
            % TitleEngLines == 2
            英文论文题目：& \zihao{4} \uline{\hfill \TitleEngLineOne{}} \\
