...
Thus, it is relatively more efficient compared with cryptographic methods, although still costs more communication than centralized training.
...
\textbf{(3) Accelerating the non-linear function evaluation based on combining secret sharing and random permutation.}
...
%
This article proposes the privacy-preserving nonlinear element-wise function evaluation based on random permutation and semi-honest third-party.
%
...
\textbf{(4) Achieving secure large language model inference within seconds.}
...
%
We also implement the open-source large lanugage model based on our framework and realize private inference within seconds.
%